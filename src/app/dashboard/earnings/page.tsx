      ...
      {/* Earnings Overview */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="glass-card p-6">
            ...
            <p className="text-3xl font-bold text-white">₹{earnings.sipInvestments.toLocaleString()}</p>
          ...
          <div className="glass-card p-6">
            ...
            {earnings.insurancePlan ? (
              <>
                <p className="text-lg font-semibold text-white">{earnings.insurancePlan}</p>
                <p className="text-sm text-gray-400 mt-1">Active coverage</p>
              </>
            ) : (
              <>
                <p className="text-lg font-semibold text-gray-400">No Plan</p>
                <button className="text-sm text-slate-300 hover:text-white transition-colors mt-1">
                  Get Coverage
                </button>
              </>
            )}
            ...
            <div className="mb-4">
              ...
              <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-slate-300">Monthly Investment</span>
                  <span className="font-semibold text-white">₹{earnings.sipInvestments.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-slate-300">Expected Annual Return</span>
                  <span className="font-semibold text-white">12-15%</span>
                </div>
              </div>
            </div>
            
            <button className="w-full bg-slate-700 hover:bg-slate-600 text-white py-3 rounded-lg transition-all flex items-center justify-center gap-2 font-medium">
              ...
              {earnings.insurancePlan ? (
                <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="font-semibold text-white">{earnings.insurancePlan}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-300">Coverage</span>
                    <span className="font-semibold text-white">₹5,00,000</span>
                  </div>
                </div>
              ) : (
